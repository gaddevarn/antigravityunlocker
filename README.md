...
Тем, что вайб-кодер ломал путём декомпиляции с помощью нейросети мой анлокер (оригинал) и выставляет теперь как свой ([подделку](https://github.com/AvenCores/open-antigravity-patcher)). Что именно он туда зашил и какие сюрпризы может использовать - известно только ему.
