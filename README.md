...
Тем, что [этот вайб-кодер](https://github.com/AvenCores/open-antigravity-patcher) ломал путём декомпиляции с помощью нейросети мой анлокер и выставляет теперь как свой. Как именно он его использует и какие сюрпризы туда зашил - только ему известно. У меня - оригинал, у него - подделка. 
