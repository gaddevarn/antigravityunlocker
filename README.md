...
Тем, что вайб-кодер ломал путём декомпилирования мой анлокер (оригинал) с помощью нейросети и теперь выставляет как свой ([подделку](https://github.com/AvenCores/open-antigravity-patcher)). Что именно он туда зашил и какие сюрпризы может использовать - известно только ему.
